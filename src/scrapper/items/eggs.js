...
// Localiza o elemento com o ID 'Eggs'
const spanElement = await page.$('#Eggs');

logger.info('found Eggs element')
...
logger.info('clicked on Eggs element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de eggs.
  eggs.push({
    'name': name.trim(),
