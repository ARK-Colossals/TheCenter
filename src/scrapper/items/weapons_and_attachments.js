...
// Localiza o elemento com o ID 'Weapons_and_Attachments'
const spanElement = await page.$('#Weapons_and_Attachments');

logger.info('found Weapons_and_Attachments element')
...
logger.info('clicked on Weapons_and_Attachments element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de weapons_and_attachments.
  weapons_and_attachments.push({
    'name': name.trim(),
...
fileContentJson.weapons_and_attachments = weapons_and_attachments 
