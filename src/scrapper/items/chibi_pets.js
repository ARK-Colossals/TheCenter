...
// Localiza o elemento com o ID 'Chibi_Pets'
const spanElement = await page.$('#Chibi_Pets');

logger.info('found Chibi_Pets element')
...
logger.info('clicked on Chibi_Pets element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de chibi_pets.
  chibi_pets.push({
    'name': name.trim(),
...
fileContentJson.chibi_pets = chibi_pets 
