...
// Localiza o elemento com o ID 'Skins'
const spanElement = await page.$('#Skins');

logger.info('found Skins element')
...
logger.info('clicked on Skins element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de skins.
  skins.push({
    'name': name.trim(),
