...
// Localiza o elemento com o ID 'Armor'
const spanElement = await page.$('#Armor');

logger.info('found Armor element')
...
logger.info('clicked on Armor element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de armor.
  armor.push({
    'name': name.trim(),
