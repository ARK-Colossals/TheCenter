...
// Localiza o elemento com o ID 'Farming'
const spanElement = await page.$('#Farming');

logger.info('found Farming element')
...
logger.info('clicked on Farming element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de farming.
  farming.push({
    'name': name.trim(),
...
fileContentJson.farming = farming 
