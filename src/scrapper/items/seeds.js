...
// Localiza o elemento com o ID 'Seeds'
const spanElement = await page.$('#Seeds');

logger.info('found Seeds element')
...
logger.info('clicked on Seeds element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de seeds.
  seeds.push({
    'name': name.trim(),
