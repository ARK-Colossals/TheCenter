...
// Localiza o elemento com o ID 'Dye'
const spanElement = await page.$('#Dye');

logger.info('found Dye element')
...
logger.info('clicked on Dye element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de dye.
  dye.push({
    'name': name.trim(),
