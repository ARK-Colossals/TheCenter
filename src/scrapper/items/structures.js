...
// Localiza o elemento com o ID 'Structures'
const spanElement = await page.$('#Structures');

logger.info('found Structures element')
...
logger.info('clicked on Structures element show button')
...
tableData.slice(2).forEach(row => {
  ...
  // Salva os dados no nosso array de structures.
  structures.push({
    'name': name.trim(),
...
fileContentJson.structures = structures 
