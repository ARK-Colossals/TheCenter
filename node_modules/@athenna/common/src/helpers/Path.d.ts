...
export declare class Path {
     ...
     */
    static removeExt(path: string): string;
    /**
     ...
     */
    static parseExt(path: string): string;
    /**
     * Convert a path to URL.
     */
    static toURL(path: string): URL;
    /**
     * Convert URL or URL href to path.
     */
    static toPath(url: string | URL): string;
    /**
     * Convert a path to URL href.
     */
    static toHref(path: string): string;
    /**
     ...
     */
    static fixtures(subPath?: string): string;
    /**
     * Set the directory of fixtures folder.
     */
    static setFixtures(directory: string): typeof Path;
    /**
     ...
     */
    static guards(subPath?: string): string;
    /**
     * Set the directory of guards folder.
     */
    static setGuards(directory: string): typeof Path;
    /**
     ...
     */
    static models(subPath?: string): string;
    /**
     * Set the directory of models folder.
     */
    static setModels(directory: string): typeof Path;
    /**
     ...
     */
    static jobs(subPath?: string): string;
    /**
     * Set the directory of jobs folder.
     */
    static setJobs(directory: string): typeof Path;
    /**
     * Return the workers' path of your project.
     */
    static workers(subPath?: string): string;
    /**
     * Set the directory of workers folder.
     */
    static setWorkers(directory: string): typeof Path;
    /**
     ...
     */
    static validators(subPath?: string): string;
    /**
     * Set the directory of validators folder.
     */
    static setValidators(directory: string): typeof Path;
    /**
